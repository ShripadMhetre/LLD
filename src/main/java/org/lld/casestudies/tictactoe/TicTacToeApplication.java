...
import org.lld.casestudies.tictactoe.exceptions.InvalidSymbolException;
...
public class TicTacToeApplication {
    ...
    private static Game createGame(HumanPlayer humanPlayer) {
        ...
        GameSymbol botSymbol = decideBotSymbol(humanPlayer.getSymbol());
        Player botPlayer = new BotPlayer(botSymbol, GameLevel.EASY, new RandomPlayingStrategy());
        return Game.builder()
                .withSize(BOARD_SIZE)
